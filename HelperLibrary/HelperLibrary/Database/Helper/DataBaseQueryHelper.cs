...
namespace HelperLibrary.Database
{
    public class DataBaseQueryHelper
    {
        ...
        public static void DeleteYahooRecord(IDataRecord selectedRecord)
        {
            try
            {
                using (SQLCmd.Connection = DataBaseFactory.Create(new MySqlConnection()))
        ...
        public static IEnumerable<IDataRecord> GetSinglePriceHistory(int secid, DateTime? start = null)
        {
            using (SQLCmd.Connection = DataBaseFactory.Create(new MySqlConnection()))
            {
                if (start != null)
